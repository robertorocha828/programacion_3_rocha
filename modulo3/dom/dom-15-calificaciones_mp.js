// dom13-calificaciones_mp.js
// Arreglo de objetos: inscritos con nombre y nota (0-10)
...
function agregarAlumno() {
   ...
   if (nombre === '') {
       divError.textContent   = 'Por favor ingresa el nombre del inscrito.';
...
// ── Renderizar la tabla de inscritos ───────────────────────────────────────
...
function calcularEstadisticas() {
   ...
   if (alumnos.length === 0) {
       divError.textContent   = 'Agrega al menos un inscrito antes de calcular.';
       divError.style.display = 'block';
       return;
   }
...
// Enter en los campos de ingreso agrega el inscrito
window.onload = () => {
