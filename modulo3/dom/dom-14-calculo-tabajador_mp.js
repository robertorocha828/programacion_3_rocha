// dom12-sueldo-trabajador_mp.js
// Cargos      : costo base del curso + material adicional
// Descuentos  : descuento parroquial (% del costo base) + descuento por beca
...
function calcularSueldo() {
   ...
   if (isNaN(sueldoBase) || sueldoBase <= 0) {
       divError.textContent   = 'Ingresa un costo base válido (mayor que cero).';
   ...
   if (isNaN(porcentajeIESS) || porcentajeIESS < 0 || porcentajeIESS > 100) {
       divError.textContent   = 'El porcentaje de descuento debe estar entre 0 y 100.';
       divError.style.display = 'block';
       return;
   }
