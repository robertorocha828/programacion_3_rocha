    ...
    <div style={{ maxWidth: 500 }}>
      ...
      {user && !loading && (
        <div style={{ padding: 14, border: '1px solid #e5e7eb', borderRadius: 8 }}>
          ...
          <p style={{ margin: '0 0 4px', fontWeight: 600 }}>{user.address.street}</p>
          <p style={{ margin: '0 0 4px', fontWeight: 600 }}>{user.address.city}</p>
          <p style={{ margin: '0 0 4px', fontWeight: 600 }}>{user.website}</p>
